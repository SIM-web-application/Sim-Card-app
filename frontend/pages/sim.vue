            ...
            <div v-if="currentStep === 3" class="col-span-3 lg:ml-10">
                <div class="grid grid-cols-3">
                    <form @submit.prevent="goToNextStep" class="col-span-3 lg:col-span-2 px-4 ">
                        ...
                        <div class=" lg:flex lg:justify-between font-semibold space-y-5">
                            <div
                        ...
                        <button class="border w-full p-2 rounded-md bg-[#FF353C] text-white">Tiến hành đặt
                            hàng</button>
                    </form>
                </div>
            </div>
            <div v-if="currentStep >= 4" class="col-span-3 lg:ml-10 flex flex-col justify-between lg:flex-none h-screen">
                <div class="grid grid-cols-3 ">
                ...
                <div :class="currentStep <=4 ? 'border-t-2':''" class=" lg:w-2/3 px-4">
                    ...
                    <a v-if="currentStep === 5" href="/" @click.prevent="goToMainPage"
                        class="w-full p-4 rounded-md text-[#FF353C] lg:border text-center inline-block">
...
const handleFormSubmit = (formData) => {
  ...
  // Thực hiện các hành động cần thiết khi form được submit
}
